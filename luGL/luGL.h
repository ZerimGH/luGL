...
// For example, create_shader_program(2, "source/shaders/vertex_shader.vert", "source/shaders/fragment_shader.frag") would compile both vertex_shader.vert and fragment_shader.frag, and link them to the shader program that is returned.
